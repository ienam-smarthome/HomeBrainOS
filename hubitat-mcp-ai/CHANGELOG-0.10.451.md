...
- Bind parsed calendar semantics to the current async request only, so concurrent WebUI/API requests cannot leak time-window interpretation across sessions.
