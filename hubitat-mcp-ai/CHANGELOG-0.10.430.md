...
- Reuse a freshly fetched dashboard/device manifest as the bounded whole-home live snapshot for up to five seconds, avoiding an immediate duplicate `hub_list_devices` read for aggregate queries such as active rooms, lights, and switches.
