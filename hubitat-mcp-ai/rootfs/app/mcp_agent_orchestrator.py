                ...
                if history_reasoning_bypass and not investigative_history_bypass:
                    ...
                    messages.append({
                        ...
                        "content": (
                            ...
                            "can support a bounded conclusion. When you inspect a "
                            "related device with homebrain_device_history, set the exact "
                            "attribute you intend to correlate (for example motion or "
                            "illuminance); a generic multi-attribute history read cannot "
                            "support an attribute-specific absence claim. If deterministic "
                            "history exposes an intervalCount or bounded interval list, "
                            "treat that cardinality as authoritative for the recorded rows: "
                            "do not present a smaller subset as the complete set. For a "
                            "why/cause/trigger question, device history proves what changed "
                            "but not the cause; do not attribute a cause without direct or "
                            "materially corroborating current-turn evidence. For normal/abnormal/"
