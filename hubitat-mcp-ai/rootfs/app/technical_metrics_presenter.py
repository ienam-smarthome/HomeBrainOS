...
_COUNTER_LABELS = (
    ...
    ("causal_secondary_correlation", "Bridge secondary correlations"),
    ("causal_secondary_room_read", "Secondary room reads"),
    ("causal_secondary_controller_read", "Secondary controller reads"),
    ("causal_secondary_sensor_read", "Secondary sensor reads"),
    ("causal_secondary_repeated_sensor_pattern", "Repeated sensor patterns"),
