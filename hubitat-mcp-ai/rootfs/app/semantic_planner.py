...
class SemanticPlanner:
    ...
    def system_prompt() -> str:
        return (
            ...
            "use adjust_level with delta=null and magnitude=default. Do NOT ask for "
            ...
            "targets a room/group (for example 'living room lights'); use device for "
            "one named device. Do not invent existence.\n"
