...
# The preserved composition root builds the application. Add only the guarded
# deterministic app controller outside AI wrappers, then align release metadata.
named_app_controller = install_named_app_controller(_core.application)
