...
Current add-on version: **0.10.300**.
...
cumulative discovery duration, grounding retries and refusals, confirmation
queuing, cancellation, total duration, and the final request outcome. Its fixed
