...
| --- | --- | --- | --- |
| [Hubitat MCP AI](hubitat-mcp-ai/README.md) | 0.16.15 | Maintained | Capability-grounded semantic smart-home agent with AI intent planning, deterministic verified execution, bounded history, and grounded synthesis |
