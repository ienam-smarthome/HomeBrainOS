...
| --- | --- | --- | --- |
| [Hubitat MCP AI](hubitat-mcp-ai/README.md) | 0.15.0 | Maintained | MCP-backed semantic smart-home agent with AI intent planning, deterministic verified execution, bounded history, and grounded synthesis |
