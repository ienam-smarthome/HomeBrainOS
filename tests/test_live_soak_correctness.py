...
def test_firmware_status_intent_matches_only_progress_questions() -> None:
    ...
    assert parse_firmware_status_intent("Hows the update going?")
...
def test_hub_health_intent_matches_the_webui_button_text_and_close_variants() -> None:
    ...
    assert parse_hub_health_intent("Whats the hub health status?")
    assert parse_hub_health_intent("How's the hub health?")
    assert parse_hub_health_intent("Hows the hub health?")
    assert parse_hub_health_intent("Is the hub healthy?")
    assert parse_hub_health_intent("How is the hub doing?")
    assert parse_hub_health_intent("Hows the hub doing?")
