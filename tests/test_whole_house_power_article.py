...
from control_focus_octopus_energy import (
    ...
    is_whole_house_power_query,
    requested_octopus_period,
)


def test_the_hyphenated_whole_house_power_query_is_terminal() -> None:
...
def test_the_spaced_whole_house_power_query_is_terminal() -> None:
