...
def test_release_configuration_and_hybrid_installation_are_aligned():
    ...
    assert 'version: "0.10.42"' in config
    assert 'PREVIOUS_RELEASE_VERSION = "0.10.41"' in entrypoint
    assert 'RELEASE_VERSION = "0.10.42"' in entrypoint
