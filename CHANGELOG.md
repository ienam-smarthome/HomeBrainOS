...
- Added a v1.5 natural response formatter for watts, kilowatts, kilowatt-hours, and pounds.
- Improved Energy Advisor wording with today/yesterday energy and cost, largest current consumers, and one practical recommendation.
- Improved Daily Briefing output with occupancy, lights on, energy today, alerts, and a recommendation.
- Improved Home Health output with a simple health score and clear deductions.
- Added `/api/natural-format` for formatter checks.
- Added deterministic intent handling for questions such as “how much have I spent today?” and “anything unusual?”.
